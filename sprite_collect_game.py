...
for i in range(random.randrange(15,31)):
    # This represents a good block
    block = Block("good_block.png")
...
for i in range(random.randrange(15, 26)):
    # This represents a bad block
    block = Block("bad_block.png")
...
player = Player("player.png", 20, 15)
...
game_over_sound = pygame.mixer.Sound("tada.wav")
